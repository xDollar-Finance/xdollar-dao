...
interface LiquidityGaugeV41Interface extends ethers.utils.Interface {
  functions: {
...
export class LiquidityGaugeV41 extends Contract {
  ...
  interface: LiquidityGaugeV41Interface;
