...
const AirdropAmount = 100000 * 1e18 // 50,000 space to trove owners each week, ~ 200,000 per month, 10% of 2M emission
...
async function calculateAirdropAmounts() {
    ...
    fs.writeFileSync(`./scripts/users0207/space_airdrop.json`,
